...
export function InputRoot({ error, ...props }: InputRootProps) {
	return (
		<div
			data-error={error}
			className="group not-visited:bg-gray-800 h-12 border border-gray-600 rounded-xl 
            px-4 flex items-center gap-2 focus-within:border-gray-100 data-[error=true]:border-danger"
			{...props}
		/>
	);
}
